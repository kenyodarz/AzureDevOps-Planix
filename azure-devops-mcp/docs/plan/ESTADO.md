...
>
> **Última actualización:** 2026-09-08 · **Fase activa:** Fase 03 — Adaptador REST para API Git de
> Azure DevOps
>
...
| **03** | Adaptador REST para API Git de Azure DevOps        | `docs/fases/FASE-03-adaptador-rest-git.md`             | `docs/resultados/RESULTADO-FASE-03.md` |   🟡 PENDIENTE    |        —        |
...
> Abrir `docs/prompts/PROMPT-FASE-03.md` y ejecutar las tareas especificadas en
> `docs/fases/FASE-03-adaptador-rest-git.md` para implementar el adaptador REST WebClient que
> implementa
> `PullRequestPort` en `infrastructure/driven-adapters/rest-consumer`.
