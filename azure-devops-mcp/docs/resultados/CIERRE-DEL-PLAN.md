...
detalle cosmético; la especificación dice que declarar una capacidad es **una promesa de responder**.
...
3. **Ningún error técnico de Azure DevOps llega crudo al cliente**: los cuatro códigos son públicos y
