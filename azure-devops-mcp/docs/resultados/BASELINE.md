...
> **Fase:** [`docs/fases/fase-01.md`](../fases/fase-01.md) · **Plan:** [`docs/plan/plan-maestro.md`](../plan/plan-maestro.md)
...
> pocas líneas que se prueban se prueban bien, y que **39 de 44 mutaciones ni siquiera se ejecutan**.
...
registra en el log como *warning*… y **la pierde antes de escribirla**. `checkWithWarning` solo añade
...
> D-05 deja de ser un riesgo de arranque y pasa a ser **código muerto que induce a error**: quien lea
