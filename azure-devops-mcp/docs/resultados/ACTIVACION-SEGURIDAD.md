...
> el de producción son **el mismo artefacto**; lo único que cambia es el entorno. Los pasos (a) y (b)
...
El token que el front obtiene del IDP **no sirve** para hablar con el MCP: su audiencia es el BFF. El
...
La clave del diseño está en la tercera fila: en `PERMISSIVE` **no se desactivan** las anotaciones, se
